    ...
    var Upload = {
        ...
        uploadComplete: function(r){
            ...
            try {
                ...
                if(json.status == 200) {
                    Base.callback(me.editor, me.dialog, json.msg, "SUCCESS");
                } else {
                    Base.callback(me.editor, me.dialog, '', json.msg || 'Error!');
                }
            } catch (e){
        ...
        submit: function (callback) {
            ...
            $(me.dialog).delegate( ".edui-image-file", "change", function ( e ) {
                ...
                $('<iframe name="up"  style="display: none"></iframe>').insertBefore(me.dialog).on('load', function(){
                    ...
                    if(r == '')return;
                    //因服务器配置，网络请求已经发生了错误
                    if(r.indexOf('413 Request Entity Too Large') > -1) {
                        r = '{"status":413,"msg":"请将文件大小控制在2M以内！"}';
                    }
                    me.uploadComplete(r);
                    $(this).unbind('load');
                    $(this).remove();
